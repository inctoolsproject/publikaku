...
cl = LINETCR.LINE()
cl.login(token="EnbYGa3v1Z430njCrO5d.nU7nzHP9gaXzEhblM4VSFq.j4Bqz154XPG7RYgieGU1UhB4KmWiW27VihLBYUrXIbI=")
cl.loginResult()
...
Bots=[mid]
admin = ["ud9d22b8295a359110ca645abaf61857a","uc9cf626eb815a70d59c8e71f9fda4872"]
owner = ["ud9d22b8295a359110ca645abaf61857a","uc9cf626eb815a70d59c8e71f9fda4872"]
...
#==============================================================================#
              ...
              if msg.toType == 2:
                ...
                cl.sendText(msg.to, "Sebentar Bong...")
                start = time.time()
                time.sleep(0.00009)
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))    
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Jangan Cakap Kontol\nGak Baik Tauk(｀・ω・´)\n\n "  +  datetime.now().strftime('%H:%M:%S'))
                    print "kontol"

            elif "babi" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Jangan Cakap Babi\nGak Baik Tauk(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "babi"
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "Hallo Kak\nSemoga Harimu Menyenangkan(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "Hallo"

            elif "hallo eclipse" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "Hallo kak \nSemoga harimu menyenangkan Ya(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "hallo eclipse"

            elif "ajg" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Jangan Cakap ajg\nGak Baik Tauk(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "ajg"

            elif "suek" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Jangan Cakap suek\nGak Baik Tauk(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "suek"

            elif "asu" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Jangan Cakap asu\nGak Baik Tauk(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "asu"

            elif "anjeng" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Jangan Cakap anjeng\nGak Baik Tauk(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "anjeng"

            elif "mak" in msg.text:
	        lurkGroup = ""
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    contactArr = rr.readlines()
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "eh Kamu Siapa?\nManggil Gw emak(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "mak"
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        cl.sendText(msg.to, "Moga betah ya kaka\nKenalkan Aku Afika(｀・ω・´)\n\n " + datetime.now().strftime('%H:%M:%S'))
                    print "welcome"
...
#==============================================#
        ...
        if op.type == 17:
          ...
          random.choice(KAC).sensText(op.param1, "Selamat Datang Di Grup  " + str(ginfo.name))
          random.choice(KAC).sensText(op.param1,"Budayakan Baca Note !!! yah Ka 😊\nSemoga Betah Kk 😘")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sensText(op.param1, "Semoga Amal Ibadahnya Diterima🙂 ")
